...
import (
	...
	"github.com/khulnasoft/triangle/cmd/common/validate"
	cmdConfig "github.com/khulnasoft/triangle/cmd/config"
	"github.com/khulnasoft/triangle/cmd/list"
	"github.com/khulnasoft/triangle/cmd/observe"
	"github.com/khulnasoft/triangle/cmd/record"
	"github.com/khulnasoft/triangle/cmd/reflect"
	"github.com/khulnasoft/triangle/cmd/status"
	"github.com/khulnasoft/triangle/cmd/version"
	"github.com/khulnasoft/triangle/cmd/watch"
...
func NewWithViper(vp *viper.Viper) *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:           "triangle",
		Short:         "CLI",
		Long:          `Triangle is a utility to observe and inspect recent Shipyard routed traffic in a cluster.`,
	...
	// so that "triangle --server foo observe" still works
