...
// ServerFlags are flags that configure how to connect to a Triangle server.
...
func initServerFlags() {
	ServerFlags.String(KeyServer, defaults.ServerAddress, "Address of a Triangle server. Ignored when --input-file is provided.")
	ServerFlags.Duration(KeyTimeout, defaults.DialTimeout, "Triangle server dialing timeout")
	...
	ServerFlags.Bool(
		KeyTLS,
		false,
		"Specify that TLS must be used when establishing a connection to a Triangle server.\r\n"+
	...
	ServerFlags.String(
		...
		"",
		"Path to the public key file for the client certificate to connect to a Triangle server (implies TLS).\r\n"+
			"The file must contain PEM encoded data.",
	)
	ServerFlags.String(
		KeyTLSClientKeyFile,
		"",
		"Path to the private key file for the client certificate to connect a Triangle server (implies TLS).\r\n"+
			"The file must contain PEM encoded data.",
	)
	ServerFlags.String(
		KeyTLSServerName,
		"",
		"Specify a server name to verify the hostname on the returned certificate (eg: 'instance.triangle-relay.khulnasoft.com').",
	)
	ServerFlags.String(
